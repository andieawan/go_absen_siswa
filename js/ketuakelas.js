...
import { getInfoKetuaKelas, submitAbsenKetuaKelas } from './api.js?v=20260731l';
import { escapeHtml, showGlobalLoading, hideGlobalLoading, showNotification } from './utils.js?v=20260731l';
